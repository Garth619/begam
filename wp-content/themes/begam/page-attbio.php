...
<p>Mr. Marks has earned an AV® Preeminent™ Peer Review Rating by Martindale-Hubbell®, the highest rating given for legal ability and ethical standards. He has also been selected as a Top Attorney in Arizona by the prestigious Southwest Super Lawyers since 2007 and is a member of the National Trial Lawyers Top 100 Trial Lawyers, Arizona. He has also been selected to Arizona’s Finest Lawyers.</p>
			...
			<div class="att_bio_sidebar">
				...
				<div class="sidebar_col">
					...
					<span class="list_title">Admissions</span><!-- list_title -->
					
					<ul>
						<li>Arizona, 1996</li>
						<li>U.S. Supreme Court, 1973</li>
					</ul>
					...
					<span class="list_title">Professional Associations</span><!-- list_title -->
					
					<ul>
						<li>LL.B., New York University, 1965<i><br/>American Jurisprudence Awards for Procedure and Torts</i></li>
						<li>U.S. Supreme Court, 1973</li>
					</ul>
				...
				<div class="sidebar_col">
					...
					<span class="list_title">Education</span><!-- list_title -->
					...
					<span class="list_title">Volunteer Experience</span><!-- list_title -->
